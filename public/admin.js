...
function settingsCard(){const s=data.settings;return `<details class='card' id='restaurant-settings' open><summary><h3>Restaurant settings</h3></summary><label>Restaurant name<input data-settings='restaurantName' value='${s.restaurantName||''}'></label><label>Phone number<input data-settings='phone' value='${s.phone||''}'></label><label>Address<input data-settings='address' value='${s.address||''}'></label><label>Google Maps URL<input data-settings='googleMapsUrl' value='${s.googleMapsUrl||''}'></label><label>Instagram URL<input data-settings='instagramUrl' value='${s.instagramUrl||''}'></label>${langFields(s,'openingHours')}${langFields(s,'footerText')}<label>Optional hero image URL<input data-settings='heroImageUrl' value='${s.heroImageUrl||''}'><small class='help-text'>Vnesi direkten URL do slike, ki se konča z .jpg, .png ali .webp.</small></label></details>`;}
