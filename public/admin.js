...
function sidebar(){const iconMap={daily:"<path d='M8 7h10M8 12h10M8 17h10'/><path d='M4 7h.01M4 12h.01M4 17h.01'/>",lunch:"<circle cx='12' cy='12' r='7.5'/><path d='M7.5 16.5c1.2-1.2 2.8-1.8 4.5-1.8s3.3.6 4.5 1.8'/>",weekly:"<rect x='4' y='5.5' width='16' height='14' rx='2'/><path d='M8 3.8v3.4M16 3.8v3.4M4 10h16'/>",desserts:"<path d='M6 10h12l-2.2 8.2a2 2 0 0 1-1.9 1.5h-3.8a2 2 0 0 1-1.9-1.5z'/><path d='M12 10V7.3c0-1.2.8-2.1 2-2.5'/>",tea:"<path d='M6 8h10v8.2a2.2 2.2 0 0 1-2.2 2.2H8.2A2.2 2.2 0 0 1 6 16.2z'/><path d='M16 10h1.3a2.2 2.2 0 1 1 0 4.4H16'/>",coffee:"<path d='M6 8h10v8.2a2.2 2.2 0 0 1-2.2 2.2H8.2A2.2 2.2 0 0 1 6 16.2z'/><path d='M16 10h1.3a2.2 2.2 0 1 1 0 4.4H16'/><path d='M9 5.5c.7.6.7 1.5 0 2.1M12 5.2c.8.7.8 1.8 0 2.5'/>",juices:"<path d='M7 5h10l-1.6 14.2a1.8 1.8 0 0 1-1.8 1.6h-3.2a1.8 1.8 0 0 1-1.8-1.6z'/><path d='M9.5 10.5h5'/>",settings:"<circle cx='12' cy='12' r='3.2'/><path d='M19 12a7 7 0 0 0-.1-1l2-1.5-2-3.5-2.4.8a7 7 0 0 0-1.8-1.1L14.3 3h-4.6l-.4 2.7a7 7 0 0 0-1.8 1.1l-2.4-.8-2 3.5L5 11a7 7 0 0 0 0 2l-2 1.5 2 3.5 2.4-.8a7 7 0 0 0 1.8 1.1l.4 2.7h4.6l.4-2.7a7 7 0 0 0 1.8-1.1l2.4.8 2-3.5-2-1.5c.1-.3.1-.7.1-1z'/>",export:"<path d='M12 4v11M8.5 7.5 12 4l3.5 3.5'/><path d='M12 20V9M8.5 16.5 12 20l3.5-3.5'/>",qr:"<path d='M4 4h6v6H4zM14 4h6v6h-6zM4 14h6v6H4z'/><path d='M14 14h2v2h-2zM18 14h2v6h-6v-2h4z'/>",analytics:"<path d='M5 19V6M5 19h14'/><path d='m8 15 3-4 3 2 4-6'/>",dnevnik:"<path d='M7 4h8l3 3v13H7a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z'/><path d='M15 4v3h3M9 11h6M9 15h6'/>",cateringi:"<path d='M4.5 13h15'/><path d='M6 13v4.8M18 13v4.8'/><path d='M7.5 13c0-2.8 2-5 4.5-5s4.5 2.2 4.5 5'/>"};const icon=(kind='daily')=>`<svg width='18' height='18' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='1.7' stroke-linecap='round' stroke-linejoin='round' class='nav-icon-svg' aria-hidden='true' focusable='false'>${iconMap[kind]||iconMap.daily}</svg>`;const iconForDrink=(label)=>{const key=String(label||'').toLowerCase();if(key.includes('čaj')||key.includes('tea')) return icon('tea');if(key.includes('kava')||key.includes('coffee')) return icon('coffee');if(key.includes('sok')||key.includes('juice')) return icon('juices');return icon('tea');};const nav=(panel,label,kind)=>`<button class='nav-link ${activePanel===panel?'active':''}' data-panel='${panel}'><span class='nav-icon' aria-hidden='true'>${kind==='drink-dynamic'?iconForDrink(label):icon(kind)}</span><span class='nav-label'>${label}</span></button>`;return `<aside class='sidebar'><div class='brand-mini'>CASA DE RIN</div><div class='sidebar-sub'>Upravljanje menija</div><nav><h5><span>MENI</span></h5>${nav('daily','Dnevna ponudba','daily')}${nav('lunch','Kosilo','lunch')}${nav('weekly','Tedenska ponudba','weekly')}${nav('desserts','Sladice','desserts')}<h5><span>PIJAČA</span></h5>${(data.drinkCategories||[]).map((cat,ci)=>nav(`drinks-${ci}`,t(cat.title),'drink-dynamic')).join('')}<h5><span>SISTEM</span></h5>${nav('settings','Nastavitve','settings')}${nav('export','Izvoz / Uvoz','export')}${nav('qr','QR koda','qr')}${nav('analytics','Analytics','analytics')}<h5><span>ADMIN</span></h5>${nav('dnevnik','Dnevnik','dnevnik')}${nav('cateringi','Cateringi','cateringi')}<button class='btn' id='logoutBtn'>Odjava</button></nav></aside>`;}
